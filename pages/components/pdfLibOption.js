...
const PdfLibOption = (props) => {
    ...
    return (
        <Link href="/pdfLib">
            <a css={tw` flex flex-col items-center p-8 md:w-5/12 w-full shadow-lg hover:border-2 hover:border-purple-100   h-64 hover:shadow-2xl transition ease-in duration-200   transform  hover:scale-110 hover:cursor-pointer  bg-gradient-to-r  from-gray-600 to-gray-500`}>
